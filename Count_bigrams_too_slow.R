# Tought this version would be faster by creating the bigrams ahead
# and creating the hash table ahead, but the program just stalls
# creating the hash table
# Number of bigrams is 24Million
# ----------
